<template>
  <div
    class="flex items-center gap-4 bg-white dark:bg-gray-800 rounded-2xl shadow-app pl-4 pr-1 py-1 cursor-pointer group transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[rgba(70,123,136,0.25)_0px_20px_40px] will-change-transform"
